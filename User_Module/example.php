...
<body>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select class="form-control" id="Department_one" name="dep_one" style="border-radius: 0px;" disabled="disabled">
	...
	<div class="form-group">
		<label class="col-md-2 col-md-offset-2 control-label">Department</label>
		<div class="col-md-8">
			<select class="form-control" id="Department_choice" name="dep_two" style="border-radius: 0px;" disabled="disabled">
				<option value="">Department</option>
				<option value="IT">Information Technology</option>
			    <option value="MLT">MLT</option>				
			    <option value="Micobiology">MICROBIOLOGY</option>		
...
//console.log(Department_one);
//Department_one=$("#dep_one:selected");
//department=Department_one.val();
...
var Department_two;
	...
	//=$("#Department_choice:selected").val();
	//console.log(Department_two);
//var dep_one;var dep_two;
//console.log(dep_one=$("#dep_one").val());
//console.log(dep_two=$("#dep_two").val());
...
{/*
	...
	$.ajax(
	{
				...
				method:"post",
				data:{choice:choice,choice_one:ch_one,dep_one:dep_one,choice_two:ch_two,dep_two:dep_two},
